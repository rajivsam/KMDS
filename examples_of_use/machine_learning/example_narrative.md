...
In the implementation sketch that is provided, a knowledge extraction experiment pipeline is used to provide an illustration of the first phase. This sketch illustrates how KMDS can be used to log data from an experimental workflow.
